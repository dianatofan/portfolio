  ...
  return (
    <div className="project animate__animated animate__fadeIn">
      ...
      <section className="title-section">
        <div>
          <h1 style={{ marginBottom: "10px" }}>Pet adoption app</h1>
          <h3 style={{ margin: 0, color: colors.dark, opacity: 0.5 }}>
            Connecting people looking for a new pet with their ideal companion
          </h3>
        </div>
      ...
      <section className="section" style={{ background: colors.light }}>
        ...
        <div>
          ...
          <div style={{ marginTop: "50px" }}>
            ...
            <h1 className="statement">
              {/* Design a better checkout flow focused on minimizing waste. */}
              Design an app for animal lovers helping them find and adopt pets
      ...
      <section className="quote-section" style={{ background: colors.dark }}>
        <blockquote>
          ...
          <div className="quote max-length">
            How can we encourage people adopt pets from shelters rather than
            buying from social breeders?
          </div>
